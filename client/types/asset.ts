...
export const assetConfigs: Record<AssetName, AssetConfig> = {
  XRD: {
    ...
    pool_unit_address: "resource_tdx_2_1t5za9exn05ujkdjny0ae9aq02hwfjq2cqvkr9y373xx74wlav3vntf",
    supply_APR: 5,
    borrow_APR: 10,
  },
  HUG: {
    ...
    pool_unit_address: "resource_tdx_2_1t5mfhlfdsd9sht5d59f8g8fr6gury768yzlctn9dsavetlwn3q5lrt",
    supply_APR: 5,
    borrow_APR: 10,
  },
  xUSDT: {
    ...
    pool_unit_address: "resource_tdx_2_1t586vnwk0e957c2030gkhslzmc4e2mqr8kcucnkuedjxerglx2szhg",
    supply_APR: 5,
    borrow_APR: 10,
  },
};
